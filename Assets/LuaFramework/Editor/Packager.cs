...
public class Packager {
    ...
    static void HandleExampleBundle() {
        ...
        AddBuildMap("gamescene" + AppConst.ExtName, "*.png", "Assets/Imas/img2/GameScene");
        AddBuildMap("btn" + AppConst.ExtName, "*.png", "Assets/Imas/img2/btn");
       // AddBuildMap("pukepais" + AppConst.ExtName, "*.png", "Assets/Imas/pukepais");
        AddBuildMap("pukepaiss" + AppConst.ExtName, "*.jpg", "Assets/Imas/pukepais");
        AddBuildMap("myprefab" + AppConst.ExtName, "*.prefab", "Assets/MyPrefab");
        AddBuildMap("gamescene" + AppConst.ExtName, "*.png", "Assets/Imas/img2/GameScene/gamechangjing");
    }
