...
namespace LuaFramework {
    public class GameManager : Manager {
        ...
        void Init() {
            ...
            slider = GameObject.FindGameObjectWithTag("UIRoot").transform.Find("Image/Slider").GetComponent<Slider>();
        }
        ...
        IEnumerator OnExtractResource() {
            ...
            foreach (var file in files) {
                ...
                print("加载进度————————————————>"+(++x));
                slider.value = x / files.Length; // -----------------------------------进度条
        ...
        void OnInitialize() {
            ...
            //Util.CallMethod("Game", "OnInitOK");     //初始化完成
             //Util.CallMethod("ConnectedToServer", "Connet");
             initialize = true;
